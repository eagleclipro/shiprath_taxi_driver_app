...
//base url
String url = 'https://tagxi-super-bidding.ondemandappz.com/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey = 'AIzaSyC2i8QDGBfvcbWGyn9QPPgSLV4mHw2UtQM';
String mapStyle = '';
...
registerDriver() async {
  ...
  try {
    ...
    response.fields.addAll({
      ...
      'lang': choosenLanguage,
      'transport_type': transportType, 'custom_make': mycustommake,
